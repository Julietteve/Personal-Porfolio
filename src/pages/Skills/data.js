export const skills = [
    ...
    },
    {
        ...
        kind: "Hard.",
        description: "Coding anything from scratch and seeing the magic flowing on the browser is my greatest joy. I'm always into learning new cool stuff in order to master that magic.",
        skill : ["HTML", "CSS", "Bootstrap", "Sass", "Javascript","React JS", "Redux", "Styled Components", "NPM", "Yarn", "FireBase"],
        tools : ["Visual Code", "Atom", "Github", "CMD", "Windows", "IOS", "Figma","Photoshop", "Adobe XD"],
    },
